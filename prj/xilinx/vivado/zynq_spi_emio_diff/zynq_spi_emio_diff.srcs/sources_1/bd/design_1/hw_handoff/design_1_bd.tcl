...
CONFIG.FREQ_HZ {100000000} \
  ...
  set OBUF_DS_N_1 [ create_bd_port -dir O -from 0 -to 0 OBUF_DS_N_1 ]
  set OBUF_DS_N_2 [ create_bd_port -dir O -from 0 -to 0 OBUF_DS_N_2 ]
  set OBUF_DS_N_3 [ create_bd_port -dir O -from 0 -to 0 OBUF_DS_N_3 ]
  set OBUF_DS_P [ create_bd_port -dir O -from 0 -to 0 OBUF_DS_P ]
  set OBUF_DS_P_1 [ create_bd_port -dir O -from 0 -to 0 OBUF_DS_P_1 ]
  set OBUF_DS_P_2 [ create_bd_port -dir O -from 0 -to 0 OBUF_DS_P_2 ]
  set OBUF_DS_P_3 [ create_bd_port -dir O -from 0 -to 0 OBUF_DS_P_3 ]
  set OBUF_IN [ create_bd_port -dir I -from 0 -to 0 OBUF_IN ]
...
CONFIG.C_BUF_TYPE {OBUFDS} \
  ...
  connect_bd_intf_net -intf_net diff_clock_rtl_1_1 [get_bd_intf_ports diff_clock_rtl_1] [get_bd_intf_pins util_ds_buf_2/CLK_IN_D]
  connect_bd_intf_net -intf_net processing_system7_0_DDR [get_bd_intf_ports DDR] [get_bd_intf_pins processing_system7_0/DDR]
  connect_bd_intf_net -intf_net processing_system7_0_FIXED_IO [get_bd_intf_ports FIXED_IO] [get_bd_intf_pins processing_system7_0/FIXED_IO]

  # Create port connections
  connect_bd_net -net IBUF_DS_N_1 [get_bd_ports IBUF_DS_N] [get_bd_pins util_ds_buf_2/IBUF_DS_N]
  connect_bd_net -net IBUF_DS_P_1 [get_bd_ports IBUF_DS_P] [get_bd_pins util_ds_buf_2/IBUF_DS_P]
  connect_bd_net -net OBUF_IN_1 [get_bd_ports OBUF_IN] [get_bd_pins util_ds_buf_4/OBUF_IN]
  connect_bd_net -net gnd_0_dout [get_bd_pins gnd_0/dout] [get_bd_pins processing_system7_0/SPI1_MOSI_I] [get_bd_pins processing_system7_0/SPI1_SCLK_I]
  connect_bd_net -net processing_system7_0_SPI1_MOSI_O [get_bd_pins processing_system7_0/SPI1_MOSI_O] [get_bd_pins util_ds_buf_1/OBUF_IN]
  connect_bd_net -net processing_system7_0_SPI1_SCLK_O [get_bd_pins processing_system7_0/SPI1_SCLK_O] [get_bd_pins util_ds_buf_0/OBUF_IN]
  connect_bd_net -net processing_system7_0_SPI1_SS_O [get_bd_pins processing_system7_0/SPI1_SS_O] [get_bd_pins util_ds_buf_3/OBUF_IN]
  ...
  connect_bd_net -net util_ds_buf_1_OBUF_DS_N [get_bd_ports OBUF_DS_N_1] [get_bd_pins util_ds_buf_1/OBUF_DS_N]
  connect_bd_net -net util_ds_buf_1_OBUF_DS_P [get_bd_ports OBUF_DS_P_1] [get_bd_pins util_ds_buf_1/OBUF_DS_P]
  connect_bd_net -net util_ds_buf_2_IBUF_OUT [get_bd_pins processing_system7_0/SPI1_MISO_I] [get_bd_pins util_ds_buf_2/IBUF_OUT]
  connect_bd_net -net util_ds_buf_3_OBUF_DS_N [get_bd_ports OBUF_DS_N_2] [get_bd_pins util_ds_buf_3/OBUF_DS_N]
  connect_bd_net -net util_ds_buf_3_OBUF_DS_P [get_bd_ports OBUF_DS_P_2] [get_bd_pins util_ds_buf_3/OBUF_DS_P]
  connect_bd_net -net util_ds_buf_4_OBUF_DS_N [get_bd_ports OBUF_DS_N_3] [get_bd_pins util_ds_buf_4/OBUF_DS_N]
  connect_bd_net -net util_ds_buf_4_OBUF_DS_P [get_bd_ports OBUF_DS_P_3] [get_bd_pins util_ds_buf_4/OBUF_DS_P]
  connect_bd_net -net vcc_0_dout [get_bd_pins processing_system7_0/SPI1_SS_I] [get_bd_pins vcc_0/dout]
...
preplace port diff_clock_rtl_0 -pg 1 -y 30 -defaultsOSRD
preplace port diff_clock_rtl_1 -pg 1 -y 570 -defaultsOSRD
preplace port FIXED_IO -pg 1 -y 20 -defaultsOSRD
preplace port diff_clock_rtl -pg 1 -y 10 -defaultsOSRD
preplace portBus OBUF_DS_P_3 -pg 1 -y 540 -defaultsOSRD
preplace portBus IBUF_DS_P -pg 1 -y 390 -defaultsOSRD
preplace portBus OBUF_DS_N_1 -pg 1 -y 170 -defaultsOSRD
preplace portBus OBUF_IN -pg 1 -y 550 -defaultsOSRD
preplace portBus OBUF_DS_N_2 -pg 1 -y 270 -defaultsOSRD
preplace portBus OBUF_DS_N -pg 1 -y 70 -defaultsOSRD
preplace portBus OBUF_DS_N_3 -pg 1 -y 560 -defaultsOSRD
preplace portBus OBUF_DS_P_1 -pg 1 -y 150 -defaultsOSRD
preplace portBus OBUF_DS_P_2 -pg 1 -y 250 -defaultsOSRD
preplace portBus OBUF_DS_P -pg 1 -y 50 -defaultsOSRD
preplace portBus IBUF_DS_N -pg 1 -y 410 -defaultsOSRD
preplace inst util_ds_buf_1 -pg 1 -lvl 4 -y 160 -defaultsOSRD
preplace inst gnd_0 -pg 1 -lvl 3 -y 350 -defaultsOSRD
preplace inst util_ds_buf_2 -pg 1 -lvl 6 -y 390 -defaultsOSRD
preplace inst util_ds_buf_3 -pg 1 -lvl 4 -y 260 -defaultsOSRD
preplace inst util_ds_buf_4 -pg 1 -lvl 5 -y 550 -defaultsOSRD
preplace inst vcc_0 -pg 1 -lvl 2 -y 390 -defaultsOSRD
preplace inst util_ds_buf_0 -pg 1 -lvl 4 -y 60 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 1 -y 260 -defaultsOSRD
preplace netloc processing_system7_0_DDR 1 1 6 NJ -20 N -20 N -20 N -20 N -20 N
preplace netloc util_ds_buf_1_OBUF_DS_P 1 4 3 NJ 150 NJ 150 NJ
preplace netloc util_ds_buf_0_OBUF_DS_N 1 4 3 NJ 70 NJ 70 NJ
preplace netloc util_ds_buf_2_IBUF_OUT 1 1 6 NJ 240 N 240 710 320 N 320 N 320 1530
preplace netloc processing_system7_0_SPI1_SS_O 1 1 3 NJ 260 NJ 260 N
preplace netloc util_ds_buf_0_OBUF_DS_P 1 4 3 NJ 50 NJ 50 NJ
preplace netloc util_ds_buf_4_OBUF_DS_N 1 5 2 NJ 560 NJ
preplace netloc util_ds_buf_3_OBUF_DS_N 1 4 3 NJ 270 NJ 270 NJ
preplace netloc processing_system7_0_SPI1_MOSI_O 1 1 3 310 160 NJ 160 NJ
preplace netloc vcc_0_dout 1 1 2 NJ 270 490
preplace netloc OBUF_IN_1 1 0 5 NJ 550 NJ 550 NJ 550 NJ 550 NJ
preplace netloc util_ds_buf_4_OBUF_DS_P 1 5 2 NJ 540 NJ
preplace netloc IBUF_DS_N_1 1 0 6 NJ 460 NJ 330 NJ 400 NJ 400 NJ 400 NJ
preplace netloc diff_clock_rtl_1_1 1 0 6 NJ 480 NJ 480 NJ 480 NJ 480 NJ 480 NJ
preplace netloc processing_system7_0_FIXED_IO 1 1 6 NJ 0 N 0 N 0 N 0 N 0 1530
preplace netloc util_ds_buf_3_OBUF_DS_P 1 4 3 NJ 250 NJ 250 NJ
preplace netloc IBUF_DS_P_1 1 0 6 NJ 470 NJ 340 NJ 410 NJ 410 NJ 410 NJ
preplace netloc gnd_0_dout 1 1 3 NJ 210 N 210 700
preplace netloc processing_system7_0_SPI1_SCLK_O 1 1 3 300 60 NJ 60 NJ
preplace netloc util_ds_buf_1_OBUF_DS_N 1 4 3 NJ 170 NJ 170 NJ
levelinfo -pg 1 -40 140 420 630 880 1130 1400 1550 -top -40 -bot 690
",
}
